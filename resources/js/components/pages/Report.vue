            ...
            <div class="p-6 pt-0">
                <div v-if="areas">
                    ...
                    <p class="mb-4 text-gray-700">
                        ...
                        в ключевых мегаполисах. Это свидетельствует о высокой конкуренции среди работодателей в этих локациях, что,
            ...
            <div class="p-6 pt-0">
                <div v-if="salaryByArea">
                    <p class="mb-4 text-gray-700">
                        ...
                        Средняя зарплата варьируется от {{ getMinSalary(salaryByArea) }} до {{ getMaxSalary(salaryByArea) }} руб.
                    ...
                    <p class="mb-4 text-gray-700">
                        ...
                        где развита инфраструктура ИТ-компаний, а также присутствуют филиалы международных организаций.
                    </p>
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden mb-8">
            ...
            <div class="p-6 pt-0">
                <div v-if="keySkills">
                    ...
                    <p class="mb-4 text-gray-700">
                        Преобладание этих навыков в вакансиях указывает на устойчивый спрос на специалистов, обладающих технической
                        и аналитической экспертизой. Это отражает тренды в развитии цифровой экономики и трансформации традиционных
            ...
            <div class="p-6 pt-0">
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-sm text-gray-600 mt-2" style="margin-top: 10px">
                        Выборка по данному диапазону демонстрирует, что наличие указанных навыков напрямую влияет на уровень предлагаемой зарплаты. Это может служить ориентиром как для соискателей, так и для работодателей.
                    </p>
                </div>
            </div>
        </div>
